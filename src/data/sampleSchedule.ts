// Sample project data transcribed from CABLETRAYCALCULATION_RMW_1.xlsx (sheet "CABLE SCHEDULE"),
// the reference calculation for the Raw Material Warehouse. 125 cable runs across three panels.
// Loaded on first run so the engine output can be cross-checked against the original workbook.
